...
- Photorealistic background assets are mounted as independent animated DOM layers: a shadowed Earth-like edge planet, a ringed gas giant, cratered moons, and a cinematic nebula plate move only through slow transform-based parallax.
- The live-space motion is deliberately filmed rather than gamified: a 150-second Earth axial cloud/surface pass, layered star drift and twinkle, sparse curving dust motes, slow nebula travel, and near-imperceptible planetary/orbital parallax.
